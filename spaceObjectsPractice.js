...
const { findParentDir } = require("prettier/third-party")

// The following data structure, `solarSystem`, is a common data structure: an **array** of **objects**. 
//You will see this particular data structure more and more as you venture into JSON and servers.
//This one is an ** array ** of ** objects ** which also contains ** arrays **.
...
// // 4. Add a Pluto object to the solarSystem array using .push. The object should contain Pluto's name, ringSystem boolean,
// //and moons array(which includes "Charon").
...
let x = Jupiter
let findSum = Object.values(system.x)
...
if (typeof(system.mercury.radiusp) === "string") {
  console.log(system.mercury.radiusp + ': Is a string, but not for long...')
...
let jupitersMomentum = system.jupiter.velocity * system.jupiter.mass
let plutosMomentum = system.pluto.velocity * system.pluto.mass

console.log(jupitersMomentum - plutosMomentum)
